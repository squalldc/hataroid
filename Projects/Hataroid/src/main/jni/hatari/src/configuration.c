...
static const struct Config_Tag configs_Hataroid[] =
{
	...
	{ "muteSTSound", Int_Tag, &ConfigureParams.Hataroid.muteSTSound },
...
void Configuration_SetDefault(void)
{
	...
	ConfigureParams.Midi.bEnableMidi = true;//false; // always enabled for android
	...
	ConfigureParams.Sound.nPlaybackFreq = 22050;//44100;
	...
	ConfigureParams.Hataroid.muteSTSound = 0;
	...
	// Hataroid Midi extra
	{
		fsMidi_resetSaveData(&ConfigureParams.HataroidMidi.midiState);
		ConfigureParams.HataroidMidi.midiOutEnabled = false;
		ConfigureParams.HataroidMidi.midiDevice = MIDI_DEVICE_NONE;
		ConfigureParams.HataroidMidi.fsSoundFont[0] = 0;
		ConfigureParams.HataroidMidi.fsReverb = false;
		ConfigureParams.HataroidMidi.fsChorus = false;
		ConfigureParams.HataroidMidi.fsInterp = FSMIDI_DEFAULT_INTERP;
		ConfigureParams.HataroidMidi.fsMaxPoly = FSMIDI_DEFAULT_POLYPHONY;

		ConfigureParams.Hataroid.muteSTSound = false;
...
void Configuration_MemorySnapShot_Capture(bool bSave)
{
	...
	if (gSaveVersion >= 1702)
	{
		...
		{
			MemorySnapShot_Store(&ConfigureParams.HataroidMidi.midiState, sizeof(ConfigureParams.HataroidMidi.midiState));
			MemorySnapShot_Store(&ConfigureParams.HataroidMidi.midiOutEnabled, sizeof(ConfigureParams.HataroidMidi.midiOutEnabled));
			MemorySnapShot_Store(&ConfigureParams.HataroidMidi.midiDevice, sizeof(ConfigureParams.HataroidMidi.midiDevice));
			MemorySnapShot_Store(&ConfigureParams.HataroidMidi.fsSoundFont, sizeof(ConfigureParams.HataroidMidi.fsSoundFont));
			MemorySnapShot_Store(&ConfigureParams.HataroidMidi.fsReverb, sizeof(ConfigureParams.HataroidMidi.fsReverb));
			MemorySnapShot_Store(&ConfigureParams.HataroidMidi.fsChorus, sizeof(ConfigureParams.HataroidMidi.fsChorus));
			MemorySnapShot_Store(&ConfigureParams.HataroidMidi.fsInterp, sizeof(ConfigureParams.HataroidMidi.fsInterp));
			MemorySnapShot_Store(&ConfigureParams.HataroidMidi.fsMaxPoly, sizeof(ConfigureParams.HataroidMidi.fsMaxPoly));
		}

		if (gSaveVersion >= 1705)
		{
			MemorySnapShot_Store(&ConfigureParams.Hataroid.muteSTSound, sizeof(ConfigureParams.Hataroid.muteSTSound));
		}

		if (gSaveVersion >= 1706)
		{
			MemorySnapShot_Store(&ConfigureParams.HataroidMidi.midiResetOnSTReset, sizeof(ConfigureParams.HataroidMidi.midiResetOnSTReset));
