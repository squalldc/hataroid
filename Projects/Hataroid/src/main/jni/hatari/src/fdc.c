 ...
 */
void	FDC_MemorySnapShot_Capture_New(bool bSave)
{
 ...
 */
void	FDC_Drive_Set_BusyLed_New ( Uint8 STR )
{
 ...
 *   s=side
 */
int	FDC_Get_Statusbar_Text_New ( char *text, size_t maxlen )
{
 ...
 */
void FDC_SetDMAStatus_New ( bool bError )
{
	/* Set error bit */
	if (!bError)
 ...
 */
int	FDC_DMA_GetModeControl_R_WR_New ( void )
{
 ...
 */
void	FDC_DMA_FIFO_Push_New ( Uint8 Byte )
{
	Uint32	Address;
 ...
 */
Uint8	FDC_DMA_FIFO_Pull_New ( void )
{
	Uint32	Address;
	Uint8	Byte;
 ...
 */
void	FDC_Buffer_Add_Timing_New ( Uint8 Byte , Uint16 Timing )
{
 ...
 */
void	FDC_Buffer_Add_New ( Uint8 Byte )
{
 ...
 */
Uint16	FDC_Buffer_Read_Timing_New ( void )
{
 ...
 */
Uint8	FDC_Buffer_Read_Byte_New ( void )
{
 ...
 */
Uint8	FDC_Buffer_Read_Byte_pos_New ( int pos )
{
 ...
 */
int	FDC_Buffer_Get_Size_New ( void )
{
 ...
 */
void	FDC_Drive_Set_Enable_New ( int Drive , bool value )
{
 ...
 */
void	FDC_Drive_Set_NumberOfHeads_New ( int Drive , int NbrHeads )
{
 ...
 * using the UI or command line parameters
 */
void	FDC_InsertFloppy_New ( int Drive )
{
 ...
 * using the UI or command line parameters
 */
void	FDC_EjectFloppy_New ( int Drive )
{
 ...
 */
void	FDC_SetDriveSide_New ( Uint8 io_porta_old , Uint8 io_porta_new )
{
	int	Side;
	int	Drive;
 ...
 * Drive should be a valid drive (0 or 1)
 */
int	FDC_GetBytesPerTrack_New ( int Drive )
{
	int	TrackSize;
 ...
 */
int	FDC_IndexPulse_GetCurrentPos_FdcCycles_New ( Uint32 *pFdcCyclesPerRev )
{
	Uint32	FdcCyclesPerRev;
 ...
 */
int	FDC_IndexPulse_GetCurrentPos_NbBytes_New ( void )
{
 ...
 */
int	FDC_IndexPulse_GetState_New ( void )
{
	int	state;
	int	FdcCyclesSinceIndex;
 ...
 * If there's no available drive/floppy and no index, we return -1
 */
int	FDC_NextIndexPulse_FdcCycles_New ( void )
{
	Uint32	FdcCyclesPerRev;
	int	FdcCyclesSinceIndex;
	int	res;
 ...
 */
void FDC_SetIRQ_New ( Uint8 IRQ_Source )
{
 ...
 */
void FDC_InterruptHandler_Update_New ( void )
{
	int	FdcCycles = 0;
 ...
 */
Uint8 FDC_GetCmdType_New ( Uint8 CR )
{
 ...
 */
void FDC_DiskController_WriteWord_New ( void )
{
	int FrameCycles, HblCounterVideo, LineCycles;
	int EmulationMode;
	int FDC_reg;
 ...
 */
void FDC_DiskControllerStatus_ReadWord_New ( void )
{
 ...
 */
void FDC_DmaModeControl_WriteWord_New ( void )
{
 ...
 */
void FDC_DmaStatus_ReadWord_New ( void )
{
	if (nIoMemAccessSize == SIZE_BYTE)
	{
		/* This register does not like to be accessed in byte mode on a normal ST */
 ...
 */
void	FDC_DmaAddress_ReadByte_New ( void )
{
	int FrameCycles, HblCounterVideo, LineCycles;
 ...
 */
void	FDC_DmaAddress_WriteByte_New ( void )
{
	int FrameCycles, HblCounterVideo, LineCycles;
 ...
 */
Uint32 FDC_GetDMAAddress_New(void)
{
	Uint32 Address;
 ...
 */
void FDC_WriteDMAAddress_New ( Uint32 Address )
{
	int FrameCycles, HblCounterVideo, LineCycles;
 ...
 */
void FDC_FloppyMode_WriteByte_New ( void )
{
 ...
 *           +-------- Disk changed
 */
void FDC_FloppyMode_ReadByte_New ( void )
{
