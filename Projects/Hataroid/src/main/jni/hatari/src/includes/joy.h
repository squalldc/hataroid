...
extern void Joy_SetCustomEmu(int set);
extern bool Joy_CustomDown(int joy, int joyButtonSetFlag, int joyButtonClearFlag);
extern bool Joy_CustomUp(int joy, int joyButtonClearFlag);
