...
// ANDROID UNUSED HACK
const char * _g_locale_get_charset_aliases (void) { return 0; }
const char * _g_locale_charset_raw (void) { return 0; }
const char * _g_locale_charset_unalias (const char *codeset) { return 0; }
// ANDROID UNUSED HACK
