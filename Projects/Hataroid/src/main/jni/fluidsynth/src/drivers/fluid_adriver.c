...
#if ANDROID_SUPPORT
  { "android",
    new_fluid_android_audio_driver,
    NULL,
    delete_fluid_android_audio_driver,
    NULL },
#endif
...
#elif ANDROID_SUPPORT
  fluid_settings_register_str(settings, "audio.driver", "android", 0, NULL, NULL);
#else
...
#endif
#if AUFILE_SUPPORT
  fluid_settings_add_option(settings, "audio.driver", "android");
#endif
