...
package com.RetroSoft.Hataroid.Input.InputManagerCompat;
...
public class InputManagerV16 implements InputManagerCompat {
    ...
    public InputManagerV16(Context context) {
        ...
        if (mInputManager == null) {
            throw new RuntimeException("Failed to retrieve input manager service");
        }
    ...
    @Override
    public String getDeviceDescriptor(InputDevice dev) {
        return (dev!=null) ? dev.getDescriptor() : null;
    }
