...
void main()
{
  ...
  const vec2 angle = vec2(0.0,-0.005); //vec2(0.0,-0.15);
  ...
  gl_Position = a_position; //gl_ModelViewProjectionMatrix * gl_Vertex;
  ...
  // Texture coords.
  texCoord = a_texCoord; //gl_MultiTexCoord0.xy;
   ...
   // The size of one texel, in texture-coordinates.
	...
	mod_factor = texCoord.x * color_texture_pow2_sz.x * output_size.x * 0.3 / color_texture_sz.x;
#endif
}
