...
import jp.kshoji.driver.midi.util.Nullable;
...
public final class MidiInputDevice {
	...
	private boolean midiRawEvents = true;
	...
	public void setMidiEventListenerRaw(OnMidiInputEventListener midiEventListener, boolean rawEvents) {
		this.midiEventListener = midiEventListener;
		//midiRawEvents = rawEvents;
	}
                ...
                for (i = 0; i < readSize; i += 4) {
                    ...
                    switch (codeIndexNumber) {
                        ...
                        case 2:
							...
							if (midiRawEvents && midiEventListener != null) {
								midiEventListener.onMidiRawBytes2((byte)byte1, (byte)byte2);
								break;
							}
                            if (midiEventListener != null) {
                                switch (byte1) {
                        ...
                        case 3:
							...
							if (midiRawEvents && midiEventListener != null) {
								midiEventListener.onMidiRawBytes3((byte) byte1, (byte) byte2, (byte) byte3);
								break;
							}
                            if (midiEventListener != null) {
                                switch (byte1) {
                        ...
                        case 5:
							...
							if (midiRawEvents && midiEventListener != null) {
								midiEventListener.onMidiRawBytes1((byte) byte1);
								break;
							}
                            synchronized (systemExclusive[cable]) {
                                systemExclusive[cable].write(byte1);
